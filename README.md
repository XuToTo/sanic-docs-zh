# Sanic 中文文档 [![License](https://img.shields.io/badge/license-CC%20BY--NC--SA%204.0-brightgreen.svg)](https://creativecommons.org/licenses/by-nc-sa/4.0) [![Sanic Version](https://img.shields.io/badge/sanic-0.7.0-orange.svg)](https://github.com/channelcat/sanic/tree/0.7.0) [![Build Status](https://travis-ci.org/XuToTo/sanic-docs-zh.svg?branch=master)](https://travis-ci.org/XuToTo/sanic-docs-zh)
